...
<!-- /TestMVC03/list.sp -->
        <!--   <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="/GOSUIC/list.sp">매물</a></li>-->
           ...
           <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="/GOSUIC/list.sp">매물</a></li>
          <li class="wow fadeInDown" data-wow-delay="0.3s"><a class="" href="/GOSUIC/properties.sp">매물상세</a></li>
        ...
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
          ...
          <div class="search-form wow pulse" data-wow-delay="0.8s">
            ...
            <form action="" class=" form-inline">
              ...
              <!-- 검색버튼  -->
              <button class="btn search-btn" type="submit" onclick=" window.open('/GOSUIC/findaddress.html')"><i class="fa fa-search" ></i></button>
      ...
      <div class="row">
        <div class="proerty-th">
          <div class="col-sm-6 col-md-3 p0">
            <div class="box-two proerty-item">
              <div class="item-thumb">
                <a href="property-1.html"><img src="assets/img/mainpage/topproperties/livingroom01.jpg"></a>
              </div>
              <div class="item-entry overflow">
                <h5><a href="property-1.html" >인기매물 이름1 </a></h5>
                <div class="dot-hr"></div>
                <span class="pull-left">전용면적 <b> 118.03㎡</b></span>
                <span class="proerty-price pull-right">매매 <b>14억 8,000</b></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-3 p0">
            <div class="box-two proerty-item">
              <div class="item-thumb">
                <a href="property-2.html"><img src="assets/img/mainpage/topproperties/building01.jpg"></a>
              </div>
              <div class="item-entry overflow">
                <h5><a href="property-2.html" >인기 매물 2</a></h5>
                <div class="dot-hr"></div>
                <span class="pull-left">전용면적 <b> 118.03㎡</b></span>
                <span class="proerty-price pull-right">매매 <b>57억 8,000</b></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-3 p0">
            <div class="box-two proerty-item">
              <div class="item-thumb">
                <a href="property-3.html"><img src="assets/img/mainpage/topproperties/apartment01.jpg"></a>

              </div>
              <div class="item-entry overflow">
                <h5><a href="property-3.html">인기매물3</a></h5>
                <div class="dot-hr"></div>
                <span class="pull-left">전용면적 <b> 88.03㎡</b></span>
                <span class="proerty-price pull-right">매매 <b>77억 8,000</b></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-3 p0">
            <div class="box-tree more-proerty text-center">
              ...
              <div class="more-entry overflow">
                ...
                <button class="btn border-btn more-black" value="All properties" onclick=" window.open('/GOSUIC/list.sp')">더 보기</button>
              </div>
            </div>
          </div>
